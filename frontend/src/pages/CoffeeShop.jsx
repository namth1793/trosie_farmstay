...
const CATS = [
  { id: 'all', label: 'Tất Cả' },
  { id: 'dac-san', label: 'Cà Phê Đặc Sản' },
  { id: 'hat', label: 'Hạt & Bột' },
  { id: 'bot', label: 'Cà Phê Bột' },
  { id: 'tui-nhung', label: 'Túi Nhúng' },
  { id: 'tra', label: 'Trà' },
];
    ...
    <div>
      <div className="page-hero" style={{ height: '320px' }}>
        ...
        <div className="relative z-10 text-center">
          ...
          <h1 className="font-serif text-3xl md:text-5xl text-white">Shop Sản Phẩm</h1>
        </div>
      </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          {!loading && filtered.length === 0 && (
            <div className="text-center py-20 text-gray-400">Không có sản phẩm trong danh mục này.</div>
          )}
        </div>
      </section>
      ...
      <section className="py-12 bg-forest-900 text-center">
        <div className="max-w-xl mx-auto px-4">
          <p className="text-gray-300 text-sm mb-3">Mua sỉ / hợp tác phân phối</p>
