          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              <li className="flex gap-3">
                ...
                <span className="whitespace-pre-line">{t('general.address')}</span>
              </li>
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-gold mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <a href={`tel:${t('general.phone1').replace(/\s/g,'')}`} className="block hover:text-gold">{t('general.phone1')}</a>
                  <a href={`tel:${t('general.phone2').replace(/\s/g,'')}`} className="block hover:text-gold">{t('general.phone2')}</a>
                </div>
              </li>
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-gold mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href={`mailto:${t('general.email')}`} className="hover:text-gold break-all">{t('general.email')}</a>
              </li>
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-gold mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                <span className="whitespace-pre-line">{t('general.hours')}</span>
              </li>
            </ul>
          </div>
